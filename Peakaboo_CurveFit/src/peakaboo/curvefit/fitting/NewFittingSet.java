...
public class NewFittingSet implements Serializable
{
	...
	public NewFittingSet(int dataWidth, float energyPerChannel)
	{
	...
	public synchronized void moveTransitionSeriesUp(TransitionSeries e)
	{
		...
		{
			if (fitTransitionSeries.get(i) == e)
			{
	...
	public synchronized void setTransitionSeriesVisibility(TransitionSeries element, boolean show)
	{
