...
public class MapTabController extends IActofUIController {
	...
	private void setMappingController(MappingController controller) {
		...
		controller.mapsController.setDataWidth(121);
		controller.mapsController.setDataHeight(41);
		...
		minX = 0;
		minY = 0;
		maxX = controller.mapsController.getDataWidth();
		maxY = controller.mapsController.getDataHeight();
