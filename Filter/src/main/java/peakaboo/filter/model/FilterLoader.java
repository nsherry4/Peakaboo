...
import peakaboo.filter.plugin.JavaScriptFilterPlugin;
import peakaboo.filter.plugin.plugins.advanced.DataToWavelet;
import peakaboo.filter.plugin.plugins.advanced.Identity;
import peakaboo.filter.plugin.plugins.advanced.Interpolation;
import peakaboo.filter.plugin.plugins.advanced.SpectrumNormalization;
import peakaboo.filter.plugin.plugins.advanced.SubFilter;
import peakaboo.filter.plugin.plugins.advanced.WaveletToData;
import peakaboo.filter.plugin.plugins.background.BruknerRemoval;
import peakaboo.filter.plugin.plugins.background.LinearTrimRemoval;
import peakaboo.filter.plugin.plugins.background.PolynomialRemoval;
import peakaboo.filter.plugin.plugins.mathematical.Addition;
import peakaboo.filter.plugin.plugins.mathematical.Derivative;
import peakaboo.filter.plugin.plugins.mathematical.Integrate;
import peakaboo.filter.plugin.plugins.mathematical.Multiply;
import peakaboo.filter.plugin.plugins.mathematical.Subtraction;
import peakaboo.filter.plugin.plugins.noise.AggressiveWaveletNoiseFilter;
import peakaboo.filter.plugin.plugins.noise.FourierLowPass;
import peakaboo.filter.plugin.plugins.noise.MovingAverage;
import peakaboo.filter.plugin.plugins.noise.SavitskyGolaySmoothing;
import peakaboo.filter.plugin.plugins.noise.SpringSmoothing;
import peakaboo.filter.plugin.plugins.noise.WaveletNoiseFilter;
