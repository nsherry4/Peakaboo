...
XRF data. If all scanpoint data are contained in a single file, select it to 
open the file in the data directory. If there are many individual ``scanpoint'' 
files, locate them in the directory and use \shortcut{Control}{A} to select all 
of them.
