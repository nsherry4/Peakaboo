...
//		//Fonts
		...
		if (REPLACE_PAINTERS) {
			...
			reg(ret, "Button[Default+Focused+MouseOver].backgroundPainter", 	new ButtonPainter(theme, ButtonState.DEFAULT, ButtonState.FOCUSED, ButtonState.MOUSEOVER));
			reg(ret, "Button[Default+Focused+Pressed].backgroundPainter", 	new ButtonPainter(theme, ButtonState.DEFAULT, ButtonState.FOCUSED, ButtonState.PRESSED));
			reg(ret, "Button[Default+Focused].backgroundPainter", 			new ButtonPainter(theme, ButtonState.DEFAULT, ButtonState.FOCUSED));
			reg(ret, "Button[Default+MouseOver].backgroundPainter", 			new ButtonPainter(theme, ButtonState.DEFAULT, ButtonState.MOUSEOVER));
			reg(ret, "Button[Default+Pressed].backgroundPainter", 			new ButtonPainter(theme, ButtonState.DEFAULT, ButtonState.PRESSED));
			reg(ret, "Button[Default].backgroundPainter", 					new ButtonPainter(theme, ButtonState.DEFAULT));
			reg(ret, "Button[Disabled].backgroundPainter", 					new ButtonPainter(theme, ButtonState.DISABLED));
			reg(ret, "Button[Enabled].backgroundPainter", 					new ButtonPainter(theme, ButtonState.ENABLED));
			reg(ret, "Button[Focused+MouseOver].backgroundPainter", 			new ButtonPainter(theme, ButtonState.FOCUSED, ButtonState.MOUSEOVER));
			reg(ret, "Button[Focused+Pressed].backgroundPainter", 			new ButtonPainter(theme, ButtonState.FOCUSED, ButtonState.PRESSED));
			reg(ret, "Button[Focused].backgroundPainter", 					new ButtonPainter(theme, ButtonState.FOCUSED));
			reg(ret, "Button[MouseOver].backgroundPainter", 					new ButtonPainter(theme, ButtonState.MOUSEOVER));
			reg(ret, "Button[Pressed].backgroundPainter", 					new ButtonPainter(theme, ButtonState.PRESSED));
			...
			reg(ret, "ToolBar:Button[MouseOver].backgroundPainter", 			new ButtonPainter(theme, ButtonState.MOUSEOVER));
			reg(ret, "ToolBar:Button[Pressed].backgroundPainter", 			new ButtonPainter(theme, ButtonState.PRESSED));
