...
public class BreadCrumb<T> extends JPanel {
	...
	public BreadCrumb(Function<T, String> formatter, Consumer<T> onSelect) {
		...
		goLeft.setIcon(new ImageIcon(BreadCrumb.class.getClassLoader().getResource("stratus/widgets/breadcrumb/arrow-left.png")));
		goRight = new FluentButton()
				.withButtonSize(FluentButtonSize.COMPACT)
				.withAction(this::doScrollRight);
		goRight.setIcon(new ImageIcon(BreadCrumb.class.getClassLoader().getResource("stratus/widgets/breadcrumb/arrow-right.png")));
