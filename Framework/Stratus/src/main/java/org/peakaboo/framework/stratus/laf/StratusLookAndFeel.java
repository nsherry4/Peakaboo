...
import org.peakaboo.framework.stratus.laf.painters.ComboBoxArrowPainter;
...
import org.peakaboo.framework.stratus.laf.painters.ToolTipPainter;
...
import org.peakaboo.framework.stratus.laf.painters.slider.SliderTrackPainter;
import org.peakaboo.framework.stratus.laf.painters.spinner.SpinnerArrowPainter;
import org.peakaboo.framework.stratus.laf.painters.tabs.TabPainter;
import org.peakaboo.framework.stratus.laf.painters.tabs.TabbedAreaPainter;
import org.peakaboo.framework.stratus.laf.painters.textfield.TextFieldBackgroundPainter;
import org.peakaboo.framework.stratus.laf.painters.textfield.TextFieldBorderPainter;
...
//			reg(ret, "EditorPane[Disabled].backgroundPainter", new TextFieldBackgroundPainter(theme, ButtonState.DISABLED));
			...
			reg(ret, "Table.alternateRowColor", StratusColour.darken(theme.getRecessedControl()));
			...
			//SEPARATOR
			reg(ret, "Separator.foreground", StratusColour.darken(theme.getControl()));
	...
	private static ImageIcon getImageIcon(String imageName, int size){
		...
		if (url == null){
			...
			{
				Logger.getLogger("Stratus").log(Level.WARNING, "Image not found " + imageName);
			}
