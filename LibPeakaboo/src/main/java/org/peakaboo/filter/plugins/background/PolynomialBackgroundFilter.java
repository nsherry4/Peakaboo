...
public final class PolynomialBackgroundFilter extends AbstractBackgroundFilter {
	...
	public void initialize() {
		width = new Parameter<>("Width of Polynomial", new IntegerStyle(), 300, this::validatePolynomial);
		power = new Parameter<>("Power of Polynomial", new IntegerStyle(), 3, this::validatePolynomial);
	...
	private boolean validatePolynomial(Parameter<?> p) {
