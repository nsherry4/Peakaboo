...
Peakaboo also allows users who are familiar with the Java programming language to 
add support for new file formats. See the section on ``Extending Peakaboo'' for more
information.
