...
public class TabController extends EventfulType<String> implements ITabController
{
	...
	public TabController(MapController map, List<TransitionSeries> tss)
	{
		tabModel = new TabModel(tss);
		this.map = map;
	}
